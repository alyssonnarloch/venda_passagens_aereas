...
--
-- Table structure for table `tipos_roupa`
--

DROP TABLE IF EXISTS `tipos_roupa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tipos_roupa` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dias_lavagem` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `tipos_roupa`
--

LOCK TABLES `tipos_roupa` WRITE;
/*!40000 ALTER TABLE `tipos_roupa` DISABLE KEYS */;
/*!40000 ALTER TABLE `tipos_roupa` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-11-12 18:55:04
-- MySQL dump 10.13  Distrib 5.6.24, for Win64 (x86_64)
--
...
INSERT INTO `clients` VALUES (1,'Alysson Narloch','1234'),(2,'Patrícia Alves','1234'),(3,'Juliana Pereira','1234');
...
CREATE TABLE `purchases` (
  ...
  CONSTRAINT `schedule_fk` FOREIGN KEY (`schedule_id`) REFERENCES `schedules` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
LOCK TABLES `purchases` WRITE;
/*!40000 ALTER TABLE `purchases` DISABLE KEYS */;
INSERT INTO `purchases` VALUES (1,1,1,1000.00,1,'2015-10-25 16:25:21');
/*!40000 ALTER TABLE `purchases` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `accounts` VALUES (1,489,87983,5000.00),(2,575,63556,122.95),(3,781,88246,15759.21);
