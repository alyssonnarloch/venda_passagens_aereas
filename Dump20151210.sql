...
CREATE TABLE `purchases` (
  ...
  `start_destination_name` varchar(100) DEFAULT NULL,
  `end_destination_name` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `purchases` VALUES (7,1,2,1,'2015-11-01 14:12:00','2015-11-01 15:55:00',244.19,1,87983,489,'2015-12-10 20:48:23','Rio de Janeiro (Galeão)','São Paulo (Campinas)'),(8,1,2,1,'2015-11-01 14:12:00','2015-11-01 15:55:00',244.19,1,87983,489,'2015-12-10 20:51:41','Rio de Janeiro (Galeão)','São Paulo (Campinas)');
...
-- Dump completed on 2015-12-10 22:29:39
-- MySQL dump 10.13  Distrib 5.6.24, for Win64 (x86_64)
--
...
CREATE TABLE `purchases` (
  ...
  `end_destination_id` int(11) DEFAULT NULL,
  `start_at` datetime DEFAULT NULL,
  `start_destination_id` int(11) DEFAULT NULL,
  `client_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `schedule_fk_idx` (`schedule_id`),
  KEY `FK_4g2dwhnlswa8jbm1dm1xktdt9` (`client_id`),
  CONSTRAINT `FK_4g2dwhnlswa8jbm1dm1xktdt9` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`),
...
LOCK TABLES `purchases` WRITE;
/*!40000 ALTER TABLE `purchases` DISABLE KEYS */;
INSERT INTO `purchases` VALUES (1,1,1000.00,1,'2015-10-25 16:25:21',0,0,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `purchases` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `accounts` VALUES (1,87983,489,1581.34),(2,575,63556,122.95),(3,781,88246,15759.21);
...
-- Dump completed on 2015-12-10 22:29:40
